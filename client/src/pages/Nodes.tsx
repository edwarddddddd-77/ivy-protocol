        ...
        <div className="min-h-screen pt-24 px-4 flex items-center justify-center">
          <GlassCard className="p-8 text-center max-w-md w-full">
            ...
            <p className="text-gray-400 mb-6">
              Secure connection required. Please connect your wallet to access the Node Console.
            </p>
            <a 
              href="/"
        ...
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          >
            ...
            <p className="text-gray-400 mt-2 max-w-2xl">
              Purchase and manage your Genesis Node NFTs. Each node grants permanent mining boosts and network privileges.
            </p>
          </motion.div>
          ...
          >
            <GlassCard className="p-6">
              <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                <span className="text-primary">◈</span> NODE PRIVILEGES
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                  <div className="text-3xl font-bold text-primary mb-2">+10%</div>
                  <div className="text-sm text-white font-bold">Self Boost</div>
                  <div className="text-xs text-gray-400 mt-1">
                    Permanent mining power increase for node holders
                  </div>
                </div>
                <div className="p-4 rounded-lg bg-purple-500/5 border border-purple-500/20">
                  <div className="text-3xl font-bold text-purple-400 mb-2">+2%</div>
                  <div className="text-sm text-white font-bold">Team Aura</div>
                  <div className="text-xs text-gray-400 mt-1">
                    Bonus granted to all your direct referrals
                  </div>
                </div>
                <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                  <div className="text-3xl font-bold text-blue-400 mb-2">1,386</div>
                  <div className="text-sm text-white font-bold">Max Supply</div>
                  <div className="text-xs text-gray-400 mt-1">
                    Limited edition Genesis Nodes - first come, first served
                  </div>
                </div>
              </div>
            </GlassCard>
